...
- [x] **4 - Desenvolvimento da API REST (FastAPI)**
...
- [ ] **12 - Dashboard Web (React)**
  ...
  - [ ] 12.2 - Desenvolver *Painel Geral* com estatísticas macro e evolução temporal.
  - [ ] 12.3 - Desenvolver interface de *Busca e Listagem* com filtros integrados e ordenação.
  - [ ] 12.4 - Criar página de *Detalhes da Licitação* (exibindo itens, arquivos anexos e linha do tempo).
  - [ ] 12.5 - Criar painéis visuais para apresentar os *Rankings*.
- [ ] **13 - Painel Central de Alertas e Riscos**
  - [ ] 13.1 - Desenvolver tela de *Alertas* (focada no sistema, sem login/dados restritos do usuário).
  - [ ] 13.2 - Exibir alertas de "Compras Suspeitas" detectados pelas regras SQL da Fase 2.
  - [ ] 13.3 - Exibir lista de "Empresas com Risco" (fornecedores atípicos).
